...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    tensor([[ 0.0827,  1.1391, -0.8171],
            [ 0.4671, -1.7183,  0.0614],
            [-0.8109,  1.7098,  1.3263],
            [-1.4054, -0.1116,  0.0394],
            [-1.2217,  0.0032,  1.6286]], requires_grad=True)
    Parameter containing:
    tensor([[-0.0094, -1.0032, -0.8212],
            [-1.5282, -0.3041,  0.1675],
            [ 0.7304,  1.3195,  0.0748],
            [ 0.5734,  0.4789, -0.7811],
            [-0.5047, -0.4103,  0.0916]], requires_grad=True)
