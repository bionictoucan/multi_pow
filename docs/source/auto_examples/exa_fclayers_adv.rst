...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    tensor([[-0.6986, -0.5981,  1.1786],
            [-1.1232, -0.0609,  0.5496],
            [-0.0037, -0.9966, -0.7060],
            [ 0.2204,  1.3310, -0.1818],
            [ 1.6651,  2.0801,  0.8171]], requires_grad=True)
    Parameter containing:
    tensor([[ 0.3203, -1.6212,  0.4515],
            [ 1.3258,  1.3451, -0.0959],
            [ 0.8581,  0.5442, -0.4041],
            [-0.5964, -0.2750,  0.0760],
            [-0.2968,  0.3404,  0.1380]], requires_grad=True)
